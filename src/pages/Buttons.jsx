...
const dailyWorks = [
  ...
  { role: 'agricultural labour', image: aglabour },
  { role: 'car mechanic', image: carmechanic },
  { role: 'bike mechanic', image: bikemechanic },
  { role: 'auto mechanic', image: automechanic },
  { role: 'car wash', image: carwash },
  { role: 'chief', image: chief },
  { role: 'cloths washer', image: cloths },
  { role: 'garden cleaner', image: garden },
  { role: 'glass cleaner', image: glassclener },
  { role: 'kids caretaker', image: kids },
  { role: 'old people caretaker', image: oldpeople },
  { role: 'makeup artest', image: makeup },
  { role: 'photographer', image: photographer },
  { role: 'cattering', image: cattering },
  { role: 'washing dishes', image: dishwash },
];
