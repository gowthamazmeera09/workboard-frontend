...
function Sigin() {
  return (
    ...
    <div class="mb-5">
      <label for="email" class="block mb-2 text-sm font-medium mx-16 text-gray-900 dark:text-white">Your email</label>
    ...
    <div class="mb-5">
      <label for="password" class="block mb-2 text-sm font-medium mx-16 text-gray-900 dark:text-white">Your password</label>
