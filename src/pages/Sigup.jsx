...
function Signup() {
  ...
  return (
    <form className=" max-w-md  mx-auto mt-20 lg:mt-[-100px]  " onSubmit={handlesubmit}>
      ...
      <div className="mb-5">
        <label htmlFor="username" className="block mb-2 text-sm font-medium mx-16 text-gray-900 dark:text-white">Username</label>
      ...
      <div className="mb-5">
        <label htmlFor="email" className="block mb-2 text-sm font-medium mx-16 text-gray-900 dark:text-white">Your email</label>
      ...
      <div className="mb-5">
        <label htmlFor="password" className="block mb-2 text-sm font-medium mx-16 text-gray-900 dark:text-white">Create a password</label>
      ...
      <div className="mb-5">
        <label htmlFor="phonenumber" className="block mb-2 text-sm font-medium mx-16 text-gray-900 dark:text-white">Phone Number</label>
